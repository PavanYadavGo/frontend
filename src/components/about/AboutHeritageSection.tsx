      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative border border-[#f1c888]/25 rounded-2xl p-3 bg-white shadow-[0px_20px_45px_-15px_rgba(17,24,39,0.15)]">
          ...
          <div className="lg:pt-4">
            ...
            {/* Label */}
            <div className="mb-5">
              <p className="font-space-mono text-xs text-[#f1c888] uppercase tracking-[2.4px]">
                Our Story
              </p>
            </div>
            ...
            <h2 className="mb-7">
              ...
              <span className="font-fraunces italic text-[40px] md:text-[44px] leading-[1.2] text-[#f1c888] block mt-1">
            ...
            <blockquote className="border-l-4 border-[#f1c888] pl-6 mb-9">
              ...
              <p className="font-fraunces italic text-2xl leading-8 text-[#f1c888]">
            ...
            >
              <span className="font-space-mono text-sm text-[#111827] border-b border-[#111827] pb-1 group-hover:text-[#f1c888] group-hover:border-[#f1c888] transition-colors">
                Meet Our Team
              </span>

              <ArrowRight className="w-4 h-4 text-[#111827] group-hover:text-[#f1c888] group-hover:translate-x-1 transition-all" />
            </a>
