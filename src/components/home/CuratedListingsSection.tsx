...
import glassPavilion from '../../images/prop/IMG_1.jpeg';
import skylinePenthouse from '../../images/prop/IMG_2.jpeg';
import desertOasis from '../../images/prop/IMG_3.jpeg';
import coastalRetreat from '../../images/prop/IMG_4.jpeg';
    ...
    <section className="bg-[#F9F7F2] py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 pointer-events-none">
        <svg className="w-5 h-5" fill="none" viewBox="0 0 20 20">
          <path d="M0 0h20v20H0z" fill="#f1c888" opacity="0.05" />
        </svg>
      </div>
      ...
      <div className="max-w-[1280px] mx-auto px-8 relative z-10">
        ...
        <div className="flex justify-between items-center mb-16">
          <div>
            <div className="font-space-mono text-sm text-[#f1c888] uppercase tracking-widest mb-4">Exclusive Selection</div>
            <h2 className="font-fraunces text-5xl text-[#111827]">Curated Listings</h2>
          </div>

          <Link to="/properties" className="flex items-center gap-2 font-manrope font-bold text-[#f1c888] hover:gap-4 transition-all">
            View All Properties
          ...
          <div className="col-span-12 md:col-span-8 rounded-2xl overflow-hidden shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1)] relative group">
            <div className="relative h-[500px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <div className="bg-[#f1c888] inline-block px-3 py-1 rounded text-white font-manrope font-bold text-xs mb-4">
                  FEATURED
                </div>
